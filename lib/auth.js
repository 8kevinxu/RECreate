...
const DISABLED = {
  ...
  signOut: async () => {},
  updateProfile: async () => ({ error: new Error('Accounts are not configured.') }),
};

// Profile columns the app reads/writes (see supabase/schema.sql).
const PROFILE_COLS = 'id, display_name, age, bio, favorite_sports';
