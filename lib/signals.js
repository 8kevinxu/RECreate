...
export async function loadSignals() {
  ...
  const { data, error } = await supabase
    ...
    .select(
      'id, user_id, starts_at, sport, note, planned_at, planned_court_id, created_at,' +
        ...
        ' hoop_signal_participants(user_id, proposed_at, proposed_court_id, proposed_sport, profiles!user_id(display_name))'
    )
  ...
  return data
    ...
    .map((s) => {
    const participants = (s.hoop_signal_participants || [])
