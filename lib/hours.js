...
// A block may carry a third truthy element (e.g. wheelchair basketball), marked
// with an asterisk. Pass a sportId ('basketball' | 'volleyball' | ...).
...
function fmtRange([o, c, flagged]) {
  return `${fmt(o)}–${fmt(c)}${flagged ? '*' : ''}`;
}
