...
// 'city' is how the prerendered per-city landing pages (scripts/postbuild-web.js)
// hand off — /nyc/basketball links to /?city=nyc&sport=basketball, so arriving
// from search opens the app on that metro instead of the stored/default one.
const KEYS = ['tab', 'sport', 'fav', 'court', 'add', 'city'];
